...
import com.dragon.ntrudemo.wordCheck.dictionary.Hit;
...
import com.dragon.ntrudemo.wordCheck.dictionary.support.detection.ExtensionFileFilter;
    ...
    public synchronized Dictionary getVocabularyDictionary() {
        if (vocabularyDictionary == null) {
            ...
            vocabularyDictionary = new HashBinaryDictionary(
                    getVocabularyWords(), 0x3fff, 0.75f);
